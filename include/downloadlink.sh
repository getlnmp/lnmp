...
if [ "${Use_Official}" = "y" ]; then
 ...
 #  Luajit_DL="${Download_Mirror}/lib/lua/${Luajit_Ver}.tar.gz"
    LuaNginxModule_DL="https://github.com/openresty/lua-nginx-module/archive/refs/tags/${LuaNginxModule_Short}.tar.gz"
    NgxDevelKit_DL="https://github.com/vision5/ngx_devel_kit/archive/refs/tags/${NgxDevelKit_Short}.tar.gz"
    LuaRestyCore_DL="https://github.com/openresty/lua-resty-core/archive/refs/tags/${LuaRestyCore_Short}.tar.gz"
    LuaRestyLrucache_DL="https://github.com/openresty/lua-resty-lrucache/archive/refs/tags/${LuaRestyLrucache_Short}.tar.gz"
 ...
 #  Mysql_DL=""
    ...
    Libicu4c_72_1_DL="https://github.com/unicode-org/icu/releases/download/release-72-1/icu4c-72_1-src.tgz"
 ...
 #  Mysql_DL=""
    ...
    Libicu4c_DL="${Download_Mirror}/lib/icu4c/icu4c-58_3-src.tgz"
    Libicu4c_52_2_DL="${Download_Mirror}/lib/icu4c/icu4c-52_2-src.tgz"
    Libicu4c_57_1_DL="${Download_Mirror}/lib/icu4c/icu4c-57_1-src.tgz"
    Libicu4c_60_3_DL="${Download_Mirror}/lib/icu4c/icu4c-60_3-src.tgz"
    Libicu4c_63_1_DL="${Download_Mirror}/lib/icu4c/icu4c-63_1-src.tgz"
    Libicu4c_67_1_DL="${Download_Mirror}/lib/icu4c/icu4c-67_1-src.tgz"
    Libicu4c_72_1_DL="${Download_Mirror}/lib/icu4c/icu4c-72_1-src.tgz"
