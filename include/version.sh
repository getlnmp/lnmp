...
Freetype_New_Ver='freetype-2.13.3'
Curl_Ver='curl-7.88.1'
Pcre_Ver='pcre-8.45'
...
LuaNginxModule_Short="${LuaNginxModule##*-}"
LuaRestyCore_Short="${LuaRestyCore##*-}"
LuaRestyLrucache_Short="${LuaRestyLrucache##*-}"
